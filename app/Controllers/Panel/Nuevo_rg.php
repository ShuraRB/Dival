<?php 
    ...
    class Nuevo_rg extends BaseController{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/nuevo_rg", $this->cargar_datos());
        ...
        public function registrar() {
            ...
            // if(!empty($this->request->getFile('image_calzado')) && $this->request->getFile('image_calzado')->getSize() > 0){
                ...
                if($tabla_rg->insert($rg) > 0){
                    mensaje("El rg ha sido registrado exitosamente", SUCCESS_ALERT);
                    return redirect()->to(route_to('rg'));
                }//end if se inserta el usuario
                else{
                    mensaje("Hubo un error al registrar el rg. Intente nuevamente, por favor", DANGER_ALERT);
                    return $this->index();
