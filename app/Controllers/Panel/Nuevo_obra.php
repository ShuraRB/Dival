<?php 
    ...
    class Nuevo_obra extends BaseController{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/nuevo_obra", $this->cargar_datos());
        ...
        private function cargar_datos(){
            ...
            $datos['nombre_pagina'] = 'Nueva obra';
            return $datos;
        }//end cargar_datos
        ...
        public function registrar() {
            ...
            // if(!empty($this->request->getFile('image_calzado')) && $this->request->getFile('image_calzado')->getSize() > 0){
                ...
                if($tabla_obra->insert($obra) > 0){
                    mensaje("El obra ha sido registrado exitosamente", SUCCESS_ALERT);
                    return redirect()->to(route_to('obra'));
                }//end if se inserta el usuario
                else{
                    mensaje("Hubo un error al registrar el obra. Intente nuevamente, por favor", DANGER_ALERT);
                    return $this->index();
