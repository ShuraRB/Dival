<?php 
    ...
    class Nuevo_herramienta extends BaseController{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/nuevo_herramienta", $this->cargar_datos());
        ...
        private function cargar_datos(){
            ...
            $datos['nombre_pagina'] = 'Nuevo herramienta';
            return $datos;
        }//end cargar_datos
        ...
        private function subir_archivo($file = NULL){
            ...
            $file_extension = $file->getherramientaExtension();
        ...
        public function registrar() {
            ...
            // if(!empty($this->request->getFile('image_calzado')) && $this->request->getFile('image_calzado')->getSize() > 0){
                ...
                if($tabla_herramienta->insert($herramienta) > 0){
                    mensaje("El herramienta ha sido registrado exitosamente", SUCCESS_ALERT);
                    return redirect()->to(route_to('herramienta'));
                }//end if se inserta el usuario
                else{
                    mensaje("Hubo un error al registrar el herramienta. Intente nuevamente, por favor", DANGER_ALERT);
                    return $this->index();
