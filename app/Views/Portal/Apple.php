				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(RECURSOS_PORTAL_IMAGES. 'A1.jpeg');?>" alt="" class="pro-image-front">
										<img src="<?= base_url(RECURSOS_PORTAL_IMAGES. 'A1.jpeg');?>" alt="" class="pro-image-back">
									...
									<div class="item-info-product ">
										<h4><a href="<?= route_to('Producto');?>">Iphone 11 </a></h4>
										<div class="info-product-price">
											<span class="item_price">$14,999.00</span>
											<del>$15,500.00</del>
										</div>
