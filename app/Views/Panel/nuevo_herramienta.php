        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Registrar nueva herramienta</h5>
                    <h6>Todos los campos marcados con (<font color="red">*</font>) son obligatorios</h6>
                </div>
                <div class="card-body">
                    <?= form_open_multipart('registrar_herramienta',['id' => 'form-user-register','class' => 'user']); ?>
...
<?= $this->section("js") ?>
    ...
    <script type="text/javascript">
        document.getElementById("imagen-herramienta").onchange = function(e) {
